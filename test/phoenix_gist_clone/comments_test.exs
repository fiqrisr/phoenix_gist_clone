defmodule PhoenixGistClone.CommentsTest do
  use PhoenixGistClone.DataCase

  alias PhoenixGistClone.Comments

  describe "comments" do
    alias PhoenixGistClone.Comments.Comment

    import PhoenixGistClone.CommentsFixtures
