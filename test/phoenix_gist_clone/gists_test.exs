defmodule PhoenixGistClone.GistsTest do
  use PhoenixGistClone.DataCase

  alias PhoenixGistClone.Gists

  describe "gists" do
    alias PhoenixGistClone.Gists.Gist

    import PhoenixGistClone.GistsFixtures
  ...
  describe "saved_gists" do
    alias PhoenixGistClone.Gists.SavedGist
